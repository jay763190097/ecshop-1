...
require_once('cls_transport.php');
require_once('shopex_json.php');
...
//        $this->ecs = $GLOBALS['ecs'];
        ...
        $this->db = new cls_mysql('47.111.117.79:3306', 'jealook_com', 'zRnGTAdw6mXrW88L', 'jealook_com');
        $this->ecs = [
        "db_name"=> "jealook_com",
        "prefix"=>"ecs_"
];
    ...
    function send($phones,$msg,$send_date = '', $send_num = 1,$sms_type='',$version='1.0')
    {
        ...
        else
        {
            ...
            $send_str['shopexid'] = $this->get_certificate_info('passport_uid');
            $send_str['token'] = $this->get_certificate_info('yunqi_code');
            $send_str['source']=SOURCE_ID;
            $send_str['certi_app'] = 'sms.newsend';
